          ...
          <div class="mr-auto">
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                <li class="active">
                  <a href="{{route('Accueil.index')}}" class="nav-link text-left">Accueil</a>
                </li>
                <li>
                  <a href="{{route('Organisation.index')}}" class="nav-link text-left">Organisation</a>
                </li>
                <li>
                  <a href="{{route('Admissions.index')}}" class="nav-link text-left">Admissions</a>
                </li>
                <li>
                  <a href="{{route('Formations.index')}}" class="nav-link text-left">Formations</a>
                </li>
                <li>
                    <a href="{{route('Contact.index')}}" class="nav-link text-left">Contact</a>
                  </li>
              </ul>
            </nav>
          </div>
