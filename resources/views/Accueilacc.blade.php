 @extends('layout')
  @section('content')
    <div class="hero-slide owl-carousel site-blocks-cover">
      <div class="intro-section" style="background-image: url('https://source.unsplash.com/1600x900/?learning');">
        <div class="container">
      ...
      <div class="intro-section" style="background-image: url('https://source.unsplash.com/1600x900/?school');">
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-12 mx-auto text-center" data-aos="fade-up">
      ...
      <div class="intro-section" style="background-image: url('https://source.unsplash.com/1600x900/?teacher');">
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-12 mx-auto text-center" data-aos="fade-up">
              ...
              <div class="owl-slide-3 owl-carousel">
                  <div class="course-1-item">
                    <figure class="thumnail">
                      <a href="#"><img src="{{asset('images/course_1.jpg')}}" alt="Image" class="img-fluid"></a>
  ...
  <div class="site-section">
   ...
   <div class="section-bg style-1" style="background-image: url('{{asset('images/3.jpg')}}');">
    ...
    <div class="site-section ftco-subscribe-1" style="background-image: url({{asset('images/4.jpg')}})">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-7">
            <h2>Information</h2>
